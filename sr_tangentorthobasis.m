function [orthobasis, orthSig] = sr_tangentorthobasis(M, x, n)
...
%         basis{k} = M.randvec(x);
    ...
    orthobasis = sr_orthogonalize(M, x, basis);
    orthSig = M.inner(x, orthobasis, orthobasis);
%     orthSig = orthobasis' * M.sigMat * orthobasis;
